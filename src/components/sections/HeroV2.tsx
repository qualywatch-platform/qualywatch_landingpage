  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(rgba(255,255,255,0.22) 2px, transparent 2px), linear-gradient(90deg, rgba(255,255,255,0.22) 2px, transparent 2px), radial-gradient(circle at 30% 20%, rgba(255,180,100,0.35), transparent 60%), radial-gradient(circle at 70% 80%, rgba(200,84,15,0.30), transparent 60%), #FA700D",
          backgroundSize: "90px 90px, 90px 90px, 100% 100%, 100% 100%, 100% 100%",
        }}
      >
      ...
      <div className="pointer-events-none absolute bottom-0 left-1/2 z-10 h-[400px] w-[96%] max-w-[560px] -translate-x-1/2 sm:h-[616px] sm:max-w-[836px] lg:h-[704px] lg:max-w-[924px]">
        ...
        <div className="animate-float-1 pointer-events-auto absolute left-1 top-[30%] z-20 w-44 origin-top-left scale-[0.5] sm:left-4 sm:top-[14%] sm:w-48 sm:scale-100 lg:left-8 lg:w-52">
          <TiltCard
        ...
        <div className="animate-float-2 pointer-events-auto absolute left-1 top-[50%] z-20 w-60 origin-top-left scale-[0.45] sm:left-4 sm:top-[42%] sm:w-64 sm:scale-100 lg:left-2 lg:w-72">
          <TiltCard
        ...
        <div className="animate-float-3 pointer-events-auto absolute right-1 top-[34%] z-20 w-48 origin-top-right scale-[0.5] sm:right-4 sm:top-[20%] sm:w-52 sm:scale-100 lg:right-8 lg:w-56">
          <TiltCard
        ...
        <div className="animate-float-1 pointer-events-auto absolute right-1 top-[55%] z-20 w-56 origin-top-right scale-[0.45] sm:right-4 sm:top-[48%] sm:w-60 sm:scale-100 lg:right-4">
          <TiltCard
            className="rounded-3xl p-4 shadow-deep"
            style={{ background: "#0F0E0C", border: "1px solid rgba(255,255,255,0.08)" }}
          >
